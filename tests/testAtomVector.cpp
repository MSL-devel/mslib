...
int main(){
	...
	cout << "AtomVector with all atoms:" << endl;
	cout << "  full (" << full.size() << "):" << endl;
	for (AtomVector::iterator k=full.begin(); k<full.end(); k++) {
		cout << **k << endl;
	}
	cout << "====" << endl;
	cout << "List and combine partA and partB: " << endl;
	cout << "  partA (" << partA.size() << "):" << endl;
	for (AtomVector::iterator k=partA.begin(); k<partA.end(); k++) {
		cout << **k << endl;
	}
	cout << "  partB (" << partB.size() << "):" << endl;
	for (AtomVector::iterator k=partB.begin(); k<partB.end(); k++) {
		cout << **k << endl;
	}
	AtomVector partAB = partA;
	...
	for (AtomVector::iterator k=partAB.begin(); k<partAB.end(); k++) {
		cout << **k << endl;
	}
	partAB.clear();
	partAB = partA + partB;
	...
	for (AtomVector::iterator k=overlapA.begin(); k<overlapA.end(); k++) {
		cout << **k << endl;
	}
	cout << "  overlapB (" << overlapB.size() << "):" << endl;
	for (AtomVector::iterator k=overlapB.begin(); k<overlapB.end(); k++) {
		cout << **k << endl;
	}
	AtomVector overlapAB = overlapA;
	...
	for (AtomVector::iterator k=overlapAB.begin(); k<overlapAB.end(); k++) {
		cout << **k << endl;
	}
	overlapAB.clear();
	...
	AtomVector subtract = full - partB;
	cout << "  subtract (" << subtract.size() << "):" << endl;
	for (AtomVector::iterator k=subtract.begin(); k<subtract.end(); k++) {
		cout << **k << endl;
	}
}
