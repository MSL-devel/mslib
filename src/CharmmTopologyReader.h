...
inline std::string CharmmTopologyReader::getElement(std::string _atomName) { if(masses.find(_atomName) != masses.end()) { return masses[
_atomName].element; } else { return std::string(_atomName,1);} } 
