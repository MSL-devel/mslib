...
int main(int argc, char *argv[]) {
	...
	if (argc < 2) {
		cerr << "USAGE:\nexample_pdbfrag <path_of_exampleFiles_directory>" << endl;
		exit(0);
	}

	cout << "  ***************************************************************************************" << endl;
	cout << "" << endl;
	cout << "     How to use PDBFragments in MSL (" << MslTools::getMSLversion() << ")   " << endl;
	cout << "" << endl;
	cout << "  ***************************************************************************************" << endl;
	cout << endl;
	cout << endl;
	...
	PDBFragments fragDB("./tables/fragdb100.mac.db");
